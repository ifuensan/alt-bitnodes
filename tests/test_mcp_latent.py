...
def test_unique_nodes_tool_is_gone():
    # The 1/N estimate was withdrawn: an agent gets no number at all rather
    # than a wrong one, since it never reads the caveat a human would.
    assert "get_unique_nodes_estimate" not in _registered()
