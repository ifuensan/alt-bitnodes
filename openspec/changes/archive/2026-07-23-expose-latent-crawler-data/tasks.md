...
- [x] [Review][Patch] TimeoutStartSec + Wants=network-online.target en la unit [deploy/alt-bitnodes-collector.service]
...
- [x] [Review][Patch] Podar .json.tmp huérfanos [queries/block_propagation.py:146]
- [x] [Review][Patch] Normalizar hash a lowercase en load_block [queries/block_propagation.py:228]
- [x] [Review][Patch] `other` siempre último en barras de adopción [static/research.js]
- [x] [Review][Patch] Variante por red en %, tooltips con bit value [static/research.js]
- [x] [Review][Patch] Sumas por banda cuadran exactas con el total tras redondeo + test [queries/unique_nodes.py:91]
- [x] [Review][Patch] Tabla de bloques con p50/p90 por clase incl. IPv6 [templates/research.html, static/research.js]
